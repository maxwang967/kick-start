# -*- coding: utf-8 -*-
# @Time    : 2020/5/16 10:04 PM
# @Author  : morningstarwang
# @FileName: Plates.py
# @Blog: wangchenxing.com

"""Problem Dr. Patel has N stacks of plates. Each stack contains K plates. Each plate has a positive beauty value,
...
Input The first line of the input gives the number of test cases, T. T test cases follow. Each test case begins with
a line containing the three integers N, K and P. Then, N lines follow. The i-th line contains K integers, describing
